...
export const AderaLogo: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 92 24" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M12 2L3 22H7L12 12L17 22H21L12 2Z" fill="currentColor"/>
    <text x="28" y="17.5" fontFamily="system-ui, sans-serif" fontSize="15" fontWeight="600" fill="currentColor" letterSpacing="0.5">
      Adera
    </text>
  </svg>
);
